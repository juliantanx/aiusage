...
const LEGACY_PRICE_TABLE: Record<string, PriceEntry> = {
  ...
  'deepseek-v3.2':         { input: 2.01,  output: 3.01, cacheRead: 0.20,   currency: 'CNY' },
  'deepseek-v3.1':         { input: 3.94,  output: 11.9, cacheRead: 0.39,   currency: 'CNY' },
  'deepseek-v3':           { input: 2.01,  output: 7.94, cacheRead: 0.20,   currency: 'CNY' },
  'deepseek-reasoner':     { input: 3.94,  output: 15.6, cacheRead: 1.0,    currency: 'CNY' },
  'deepseek-chat':         { input: 1.93,  output: 7.87, cacheRead: 0.50,   currency: 'CNY' },
  ...
  'qwen3-coder-flash':     { input: 1.40,  output: 6.98,                    currency: 'CNY' },
  'qwen3-coder-next':      { input: 0.86,  output: 5.37,                    currency: 'CNY' },
  'qwq-plus':              { input: 5.73,  output: 17.2,                    currency: 'CNY' },
  'qwq-32b':               { input: 1.43,  output: 4.30,                    currency: 'CNY' },
  ...
  'minimax-m2.7-highspeed':{ input: 4.30,  output: 17.2, cacheRead: 0.43,  cacheWrite: 2.68, currency: 'CNY' },
