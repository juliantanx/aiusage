...
const translations = {
  en: {
    ...
    settings: {
      ...
      data: 'Data',
      device: 'Device Name',
      deviceHint: 'Display name for this device',
      weekStart: 'Week Starts On',
      weekStartSunday: 'Sunday',
      weekStartMonday: 'Monday (ISO)',
      pollInterval: 'Dashboard Poll Interval (ms)',
      parseInterval: 'Parse Interval (ms)',
      retentionDays: 'Retention Days',
      retentionHint: 'Days to keep data (0 or empty = keep forever)',
  ...
  zh: {
    ...
    settings: {
      ...
      parseInterval: '解析间隔（ms）',
      retentionDays: '数据保留天数',
      retentionHint: '0 或留空表示永久保留',
