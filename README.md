...
> aiusage does not run a built-in background parser. Schedule `aiusage parse` with cron or Task Scheduler for automatic imports, or use `aiusage pm2-start` to keep the dashboard running in the background.
